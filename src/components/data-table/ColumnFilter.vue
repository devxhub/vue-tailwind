<template>
  <div class="p-2 absolute z-1 bg-white shadow-md top-full right-0 mt-1">
    <div class="overflow-hidden flex flex-col font-normal" @click.stop="close">
      ...
      <template v-else-if="props.column.type === 'number'">
        ...
        >
          {{
            (props.columnFilterLang && props.columnFilterLang['greater_than_equal']) ??
        ...
        >
          {{
            (props.columnFilterLang && props.columnFilterLang['less_than_equal']) ??
            'Less than or equal'
          }}
        </button>
      </template>
